export default async function handler(req, res) {
  ...
  try {
    ...
    // Step 2: Create Payment Page - FIXED ₹698
const callbackUrl =
`https://khajuraho.vercel.app//api/callback/?orderId=${orderId}&email=${encodeURIComponent(customer_email)}&name=${encodeURIComponent(customer_name)}`;
